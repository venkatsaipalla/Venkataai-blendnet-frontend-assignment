...
//     newOptions[index] = value;
//     // Update the updatedQuestion state with the new options array
...
//       setCorrectOptionError("Correct option must be one of the options provided.");
//     } else {
...
//             value={updatedQuestion.correctOption}
//             onChange={(e) => handleCorrectOptionChange(e.target.value as string)}
...
//           Cancel
//         </Button>
//         <Button onClick={handleSave} color="primary" disabled={!!correctOptionError}>
//           Save
//         </Button>
//       </DialogActions>
//     </Dialog>
